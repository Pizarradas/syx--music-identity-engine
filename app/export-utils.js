...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    h1 { font-size: var(--music-type-display, 2.5rem); color: var(--semantic-color-primary); margin: 0 0 0.5rem 0; }
    h2 { font-size: var(--music-type-h1, 1.5rem); color: var(--semantic-color-primary); margin: 2rem 0 0.75rem 0; border-bottom: 1px solid color-mix(in oklch, var(--semantic-color-primary) 0.2, transparent); padding-bottom: 0.5rem; }
    h3 { font-size: var(--music-type-h2, 1.2rem); color: var(--semantic-color-primary); margin: 1.5rem 0 0.5rem 0; }
    ...
    .card { background: color-mix(in oklch, var(--semantic-color-primary) 0.08, rgba(0,0,0,0.5)); border: 1px solid color-mix(in oklch, var(--semantic-color-primary) 0.2, transparent); border-radius: ${radius}; padding: 1.25rem; margin: 1rem 0; }
...
<body>
  <div class="container">
    ...
    <div class="typo-sample" style="font-size: var(--music-type-display)">Display — Aa Bb Cc</div>
    <div class="typo-sample" style="font-size: var(--music-type-h1)">H1 — Encabezado principal</div>
    <div class="typo-sample" style="font-size: var(--music-type-h2)">H2 — Subtítulo</div>
    <div class="typo-sample" style="font-size: var(--music-type-body)">Body — Texto de párrafo con suficiente longitud para ver cómo fluye la tipografía en bloques de contenido.</div>
    <div class="typo-sample caption">Caption — Texto secundario o pie de foto</div>
